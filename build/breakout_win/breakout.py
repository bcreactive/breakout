...
class Game:
    ...
    def load_images(self):
        ...
        self.ball_lost_screen = pygame.image.load("ball_lost.png")
        self.levelup_screen = pygame.image.load("levelup.png")
        self.dmgup_image = pygame.image.load("dmg_up.png")
        self.lifeup_image = pygame.image.load("life_up.png")
        self.widthup_image = pygame.image.load("width_up.png")
        self.multiball_image = pygame.image.load("multiball.png")
        self.winscreen_image = pygame.image.load("win_screen.png")
    ...
    def check_pickup(self):    
        ...
        if self.pickup_rect.colliderect(self.platform.rect):
            if self.bonus == "multiball":
                pygame.mixer.Channel(2).play(
                    pygame.mixer.Sound('multiball.mp3'))
            else:
                pygame.mixer.Channel(2).play(
                    pygame.mixer.Sound('pickupget.mp3'))
    ...
    def dead(self):
        ...
        if self.lives > 0:
            ...
            pygame.mixer.Channel(1).play(
                pygame.mixer.Sound('balllost.mp3'))
            self.active_balls = []
            self.active_balls.append(self.ball)
            self.ball.start_pos()
        else:
            pygame.mixer.Channel(0).play(
                pygame.mixer.Sound('fail.mp3'))
            ...
            if self.highscore.grats:
                pygame.mixer.Channel(0).play(
                    pygame.mixer.Sound('highscore.mp3'))
            self.active_balls = []
            self.active_balls.append(self.ball)
    ...
    def check_level_end(self):
        ...
        if len(self.blocks) == 0:           
            ...
            if self.current_level <= 7:
                ...
                self.scorelabel.prep_level(self.current_level)
                pygame.mixer.Channel(0).play(
                    pygame.mixer.Sound('complete.mp3'))
                
            if self.current_level > 7:
                self.winscreen_visible = True
                pygame.mixer.Channel(0).play(
                    pygame.mixer.Sound('win.mp3'))
